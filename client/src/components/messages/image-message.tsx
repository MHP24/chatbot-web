...
export const ImageMessage: FC<Props> = ({ image, caption, timestamp }) => {
  return (
    <div
      className={'flex flex-col gap-2 rounded-xl text-md w-full py-4 px-6 shadow-sm bg-c1 mr-0 rounded-tl-none'}
    >
      <img src={image} alt="chat-image" className='w-full  m-auto rounded-lg'/>
